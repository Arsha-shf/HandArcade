...
Stub for the Pinch Pop game.

Contract with engine/menu.py:
    run_pinch_pop(cap, tracker) is called with the already-open cv2.VideoCapture
...
def run_pinch_pop(cap, tracker):
    print("Pinch Pop - press ESC to return to menu, 'q' to quit")
    ...
    while True:
        ...
        cv2.putText(frame, "Pinch Pop (stub)", (20, 40),
